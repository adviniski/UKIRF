...
if __name__ == '__main__':
    ...
    #files["SMDI-400k_max500repeated.csv"] = {"learning_rate": 0.0001,"reg_rate": 0,"batch_size": 256,"num_neg_sample": 4,"num_factor": 32}
    #files["SMDI-400k_max200unique.csv"] = {"learning_rate": 0.0001,"reg_rate": 0,"batch_size": 256,"num_neg_sample": 4, "num_factor": 32}
    #files["SMDI-700k_original.csv"] = {"learning_rate": 0.0005,"reg_rate": 0,"batch_size": 256,"num_neg_sample": 4,"num_factor": 32}

    files["ciaodvd-gte.csv"] = {"learning_rate": 0.0001,"reg_rate": 0.0,"batch_size": 256,"num_factor": 40}
    files["movietweetings-gte.csv"] = {"learning_rate": 0.0001,"reg_rate": 0.0,"batch_size": 256,"num_factor": 40}
    files["ml-100k-gte.csv"] = {"learning_rate": 0.0005,"reg_rate": 0.0,"batch_size": 256,"num_factor": 40}
