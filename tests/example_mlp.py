...
if __name__ == '__main__':
    ...
    #files["SMDI-700k_original.csv"] = {"learning_rate": 0.0001,"reg_rate": 0,"batch_size": 256,"num_neg_sample": 4,"num_factor": 32}

    files["ciaodvd-gte.csv"] = {"learning_rate": 0.0001,"reg_rate": 0.0,"batch_size": 256,"num_factor": 50}
    files["movietweetings-gte.csv"] = {"learning_rate": 0.0001,"reg_rate": 0.0,"batch_size": 256,"num_factor": 20}
    files["ml-100k-gte.csv"] = {"learning_rate": 0.01,"reg_rate": 0.0,"batch_size": 256,"num_factor": 50}
